...
1. Make sure your Cordova Xcode project has been [updated for Cordova 2.8]
2. Add the "iAd" framework to your Frameworks folder
...
5. In config.xml add a feature tag with value of "SAiOSAdPlugin" (see config.xml)
